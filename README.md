...
Teacher Test Mode now includes separate Minute and Second fields for a custom starting timer when No timer is turned off. Values support 0–99 minutes and 0–59 seconds; 0:00 is treated as 0:01.


## v44 audio countdown update
- 0:10–0:06: 6 warning beeps per second.
- 0:05–0:00: 12 warning beeps per second.
- Replaces the previous continuous final-five-second warning tone.


## v45 final warning audio update
- 0:10–0:06 stays at 6 warning beeps per second.
- 0:05–0:00 now layers 12 warning beeps per second over the continuous warning tone.
- Both layers stop immediately when the timer reaches zero or the test ends.
